...
object Logs{
	...
	def line2Log(line: String): Logs = {
		if (StringUtils.isNotEmpty(line)) {
			val fields: Array[String] = line.split(",", line.length)

			if (fields.length >= 84) {
				new Logs(fields(0), Utils.parseInt(fields(1)), Utils.parseInt(fields(2)), Utils.parseInt(fields(3)), Utils.parseInt(fields(4)), fields(5), fields(6), Utils.parseInt(fields(7)), Utils.parseInt(fields(8)), Utils.parseDouble(fields(9)),
					Utils.parseDouble(fields(10)), fields(11), fields(12), fields(13), fields(14), fields(15), fields(16), Utils.parseInt(fields(17)), fields(18), fields(19), Utils.parseInt(fields(20)),
					...
					Utils.parseInt(fields(73)), Utils.parseDouble(fields(74)), Utils.parseDouble(fields(75)), Utils.parseDouble(fields(76)), Utils.parseDouble(fields(77)), Utils.parseDouble(fields(78)), fields(79),
					fields(80), fields(81), fields(82), fields(83), 1)
			} else makeLogs()
